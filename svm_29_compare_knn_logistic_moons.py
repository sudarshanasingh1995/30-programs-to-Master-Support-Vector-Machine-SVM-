"""
svm_29_compare_knn_logistic_moons.py
------------------------------------
Concept: Comparing SVM, KNN, and Logistic Regression on Non-Linear Data.
...
This program:
1. Generates a non-linear interlocking half-moons synthetic dataset.
...
5. Displays a 3-panel comparison plot of the decision boundaries showing how RBF SVM and KNN adapt to curves, while Logistic Regression remains strictly linear.
"""
...
plt.suptitle('Comparison of SVM, KNN, and Logistic Regression on Moons', fontsize=16, fontweight='bold', y=1.05)
plt.tight_layout()
